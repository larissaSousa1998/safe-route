...
class GruposLocomocaoAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val card = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_group_locomotion, parent, false)
    ...
    View.OnClickListener{
        val title: TextView = itemView.findViewById(R.id.txv_title_group)
        val origem: TextView = itemView.findViewById(R.id.txv_origim_group)

        val destino: TextView = itemView.findViewById(R.id.txv_destiny_group)
        val adm: TextView = itemView.findViewById(R.id.txv_name_adm_group)
